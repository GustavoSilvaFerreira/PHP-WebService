...
function main(){
	...
	$(window).ready(function(){
		...
		if($(window).width()<=480){
			...
			$(".lis2").hide();
			$(".cabeca2").css("background-image","url(https://php-web-service-gustavoferreira.c9users.io/digiudo/view/imagens/icones/seta_baixo_branco.png)");
			$(".cabeca2").click(function(){	
				...
				var aux = $(".cabeca2").css("background-image").split("/");
					...
					if(x == "seta_baixo_branco.png"){
						$(".cabeca2").css("background-image","url(https://php-web-service-gustavoferreira.c9users.io/digiudo/view/imagens/icones/seta_cima_branco.png)");
					}else{
						$(".cabeca2").css("background-image","url(https://php-web-service-gustavoferreira.c9users.io/digiudo/view/imagens/icones/seta_baixo_branco.png)");
					}
			});
