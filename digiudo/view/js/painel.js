...
function menu(){
		...
		$("#menu-minha-conta").click(function(){
			...
			var x = aux[aux.length-1].replace(")","").replace('"',"");
			if(x == "seta_baixo.png"){
				$("#menu-minha-conta").css("background-image","url(https://php-web-service-gustavoferreira.c9users.io/digiudo/view/imagens/icones/seta_cima.png)");
			}else{
				$("#menu-minha-conta").css("background-image","url(https://php-web-service-gustavoferreira.c9users.io/digiudo/view/imagens/icones/seta_baixo.png)");
			}
